module github.com/cjx2328/gocms

go 1.12

replace (
	cloud.google.com/go => github.com/GoogleCloudPlatform/google-cloud-go v0.38.0
	github.com/cjx2328/gocms/internal => ./internal
	github.com/cjx2328/gocms/pkg => ./pkg
...
require (
	github.com/cjx2328/gocms/internal v0.0.0-00010101000000-000000000000
	github.com/cjx2328/gocms/pkg v0.0.0-00010101000000-000000000000 // indirect
)
